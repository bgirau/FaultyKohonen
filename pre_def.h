...
#define TEST_DENSITY 50
#define TEST2_DENSITY 50
#define VERBOSE 0
#define PI 3.14159
#define SIZE 16
#define INS 2
...
#define NBEPOCHLEARN 150
#define NBITEREPOCH 70
...
#define nb_experiments 32 /* number of faulty versions of the same map */
#define REST -0.15
#define k_w 1.1
#define W_E 1
#define W_I 1.5
