...
#define OPTIMIZED_WEIGHTS 0
#define INDIVIDUAL_WEIGHTS 0
#define WITH_TECHS 0
#define SEQUENTIAL 1

#define SIGMA_GAUSS 3.95
#define TEST_DENSITY 25
#define TEST2_DENSITY 25
#define VERBOSE 0
#define PI 3.14159
#define INS 2
#define DISTRIB normal_dataset
#define NBCLASSES 3
#define TESTDIV 5
#define TAU 0.3
#define TAUMIN 0.07
#define MINDIST 0.00001
#define NBEPOCHLEARN 5
