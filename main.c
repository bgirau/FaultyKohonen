  ...
  */
  ...
  for (p = 0; p < MAXFAULTPERCENT; p++) {
  	for (e = 0; e < nb_experiments; e++) {
        ...
        stddev[p] += distortion2_test[p][e][m] * distortion2_test[p][e][m];
        stddev_th[p] += distortion2_th_test[p][e][m] * distortion2_th_test[p][e][m];
        stddev_FI[p] += distortion2_FI_test[p][e][m] * distortion2_FI_test[p][e][m];
        stddev_NI[p] += distortion2_NI_test[p][e][m] * distortion2_NI_test[p][e][m];
        stddev_NF[p] += distortion2_NF_test[p][e][m] * distortion2_NF_test[p][e][m];
        ...
        stddev_faulty[p] += distortion2_test_faulty[p][e][m] * distortion2_test_faulty[p][e][m];
        stddev_th_faulty[p] += distortion2_th_test_faulty[p][e][m] * distortion2_th_test_faulty[p][e][m];
        stddev_FI_faulty[p] += distortion2_FI_test_faulty[p][e][m] * distortion2_FI_test_faulty[p][e][m];
        stddev_NI_faulty[p] += distortion2_NI_test_faulty[p][e][m] * distortion2_NI_test_faulty[p][e][m];
        stddev_NF_faulty[p] += distortion2_NF_test_faulty[p][e][m] * distortion2_NF_test_faulty[p][e][m];
        ...
        stddev_gss[p] += distortion2_test_gss[p][e][m] * distortion2_test_gss[p][e][m];
        stddev_th_gss[p] += distortion2_th_test_gss[p][e][m] * distortion2_th_test_gss[p][e][m];
        stddev_FI_gss[p] += distortion2_FI_test_gss[p][e][m] * distortion2_FI_test_gss[p][e][m];
        stddev_NI_gss[p] += distortion2_NI_test_gss[p][e][m] * distortion2_NI_test_gss[p][e][m];
        stddev_NF_gss[p] += distortion2_NF_test_gss[p][e][m] * distortion2_NF_test_gss[p][e][m];
        ...
        stddev_faulty_gss[p] += distortion2_test_faulty_gss[p][e][m] * distortion2_test_faulty_gss[p][e][m];
        stddev_th_faulty_gss[p] += distortion2_th_test_faulty_gss[p][e][m] * distortion2_th_test_faulty_gss[p][e][m];
        stddev_FI_faulty_gss[p] += distortion2_FI_test_faulty_gss[p][e][m] * distortion2_FI_test_faulty_gss[p][e][m];
        stddev_NI_faulty_gss[p] += distortion2_NI_test_faulty_gss[p][e][m] * distortion2_NI_test_faulty_gss[p][e][m];
        stddev_NF_faulty_gss[p] += distortion2_NF_test_faulty_gss[p][e][m] * distortion2_NF_test_faulty_gss[p][e][m];
    ...
    avg_NI[p] /= tt;
    avg_NF[p] /= tt;
    stddev[p] = mysqrt((stddev[p] - tt * avg[p] * avg[p])/(tt-1));
    stddev_th[p] = mysqrt((stddev_th[p] - tt * avg_th[p] * avg_th[p])/(tt-1));
    stddev_FI[p] = mysqrt((stddev_FI[p] - tt * avg_FI[p] * avg_FI[p])/(tt-1));
    stddev_NI[p] = mysqrt((stddev_NI[p] - tt * avg_NI[p] * avg_NI[p])/(tt-1)); 
    stddev_NF[p] = mysqrt((stddev_NF[p] - tt * avg_NF[p] * avg_NF[p])/(tt-1));
    ...
    avg_NI_faulty[p]  /= tt;
    avg_NF_faulty[p]  /= tt;
    stddev_faulty[p] = mysqrt((stddev_faulty[p] - tt * avg_faulty[p] * avg_faulty[p])/(tt-1)); 
    stddev_th_faulty[p] = mysqrt((stddev_th_faulty[p] - tt * avg_th_faulty[p] * avg_th_faulty[p])/(tt-1));
    stddev_FI_faulty[p] = mysqrt((stddev_FI_faulty[p] - tt * avg_FI_faulty[p] * avg_FI_faulty[p])/(tt-1));
    stddev_NI_faulty[p] = mysqrt((stddev_NI_faulty[p] - tt * avg_NI_faulty[p] * avg_NI_faulty[p])/(tt-1));
    stddev_NF_faulty[p] = mysqrt((stddev_NF_faulty[p] - tt * avg_NF_faulty[p] * avg_NF_faulty[p])/(tt-1));
    ...
    avg_NI_gss[p] /= tt;
    avg_NF_gss[p] /= tt;
    stddev_gss[p] = mysqrt((stddev_gss[p] - tt * avg_gss[p] * avg_gss[p])/(tt-1));
    stddev_th_gss[p] = mysqrt((stddev_th_gss[p] - tt * avg_th_gss[p] * avg_th_gss[p])/(tt-1));
    stddev_FI_gss[p] = mysqrt((stddev_FI_gss[p] - tt * avg_FI_gss[p] * avg_FI_gss[p])/(tt-1));
    stddev_NI_gss[p] = mysqrt((stddev_NI_gss[p] - tt * avg_NI_gss[p] * avg_NI_gss[p])/(tt-1)); 
    stddev_NF_gss[p] = mysqrt((stddev_NF_gss[p] - tt * avg_NF_gss[p] * avg_NF_gss[p])/(tt-1));
    ...
    stddev_faulty_gss[p] = mysqrt((stddev_faulty_gss[p] - tt * avg_faulty_gss[p] * avg_faulty_gss[p])/(tt-1)); 
    stddev_th_faulty_gss[p] = mysqrt((stddev_th_faulty_gss[p] - tt * avg_th_faulty_gss[p] * avg_th_faulty_gss[p])/(tt-1));
    stddev_FI_faulty_gss[p] = mysqrt((stddev_FI_faulty_gss[p] - tt * avg_FI_faulty_gss[p] * avg_FI_faulty_gss[p])/(tt-1));
    stddev_NI_faulty_gss[p] = mysqrt((stddev_NI_faulty_gss[p] - tt * avg_NI_faulty_gss[p] * avg_NI_faulty_gss[p])/(tt-1));
    stddev_NF_faulty_gss[p] = mysqrt((stddev_NF_faulty_gss[p] - tt * avg_NF_faulty_gss[p] * avg_NF_faulty_gss[p])/(tt-1));
	}
  ...
  fprintf(fp, "{ \"This file contains distortion measurements. Each measurement is calculated for each learning epoch on a TEST set\":\n{");
  for(m = 0; m < NBMAPS; m++){
  ...
  fprintf(fp, "{ \"This file contains distortion measurements. Each measurement is calculated on a TEST set\":\n{");
  for(m = 0; m < NBMAPS; m++){
    fprintf(fp, "\"Map number\": { \n\"%d\": { \n", m+1);
    // fprintf(fp, "Standard;Threshold;FaultInjection;NoiseInjetion;NeuralField;Standard_GSS;Threshold_GSS;FaultInjection_GSS;NoiseInjetion_GSS;NeuralField_GSS\n");
    for(j = 0; j < NBEPOCHLEARN; j++){
